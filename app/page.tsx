...
export default function Home() {
  return <main className="min-h-screen overflow-x-hidden bg-[#f2f0e9] pb-20 text-[#132e35] sm:pb-24">
    ...
    <footer className="border-t border-[#cbd6d2] bg-[#e8ece7] px-5 py-12 text-[#123b43] sm:px-10 lg:px-16"><div className="mx-auto flex max-w-[1312px] flex-col justify-between gap-7 sm:flex-row sm:items-center"><div className="flex items-center gap-5"><img src="/brand-logo-lockup.png" alt="Empreendedores do Reino" className="h-24 w-auto object-contain sm:h-28" /><span className="hidden max-w-[180px] text-xs leading-5 text-[#687c7e] lg:block">Negócios. Tecnologia.<br />Propósito. Impacto.</span></div><p className="max-w-md text-sm leading-6 text-[#5c7174]">Uma rede nacional para empresários que querem construir o futuro sem caminhar sozinhos.</p></div></footer>
